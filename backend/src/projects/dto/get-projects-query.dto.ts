...
export class GetProjectsQueryDto {
  ...
  @IsNumber({ allowNaN: false, allowInfinity: false, maxDecimalPlaces: 0 }, { message: '최소 시그널은 정수여야 합니다.' })
  ...
  @Transform(({ value }) => parseNumberIfPossible(value))
  @IsNumber({ allowNaN: false, allowInfinity: false, maxDecimalPlaces: 0 }, { message: '페이지는 정수여야 합니다.' })
  ...
  @Transform(({ value }) => parseNumberIfPossible(value))
  @IsNumber({ allowNaN: false, allowInfinity: false, maxDecimalPlaces: 0 }, { message: '페이지 크기는 정수여야 합니다.' })
