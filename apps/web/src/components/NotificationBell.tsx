...
/**
 * 헤더 알림 벨. Radix Popover 드롭다운. 열면 전체 읽음 처리하고,
 * 항목 클릭 시 해당 프로젝트 상세로 이동하며 닫힌다. 미읽음 개수를 배지로 표시.
  ...
  return (
    ...
    >
      <Popover.Trigger
        ...
        className="protolive-bell relative grid min-h-11 min-w-11 shrink-0 cursor-pointer place-items-center rounded-lg border border-stone-700/80 bg-stone-900/70 text-stone-300 transition hover:border-lime-300/40 hover:text-lime-100"
      >
