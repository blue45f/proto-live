...
import { type ProjectListViewMode, PROJECT_LIST_VIEW_OPTIONS, benchmarkCopy } from '../../lib/constants';
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs font-black text-stone-300">
                ...
                <label className="inline-flex items-center gap-2 rounded-lg border border-stone-700 bg-stone-950/55 px-3 py-2">
                  ...
                  <input
                    ...
                    onChange={(event) => {
                      ...
                      onMinSignalChange(Number.isFinite(next) ? Math.max(0, Math.floor(next)) : 0);
                    }}
                ...
                <label className="inline-flex items-center gap-2 rounded-lg border border-stone-700 bg-stone-950/55 px-3 py-2">
                  ...
                  <input
                    ...
                    onChange={(event) => {
                      const next = Number(event.target.value);
                      onMinFundingAmountChange(Number.isFinite(next) ? Math.max(0, Math.floor(next)) : 0);
                    }}
                ...
                <label className="inline-flex items-center gap-2 rounded-lg border border-stone-700 bg-stone-950/55 px-3 py-2">
                  ...
                  <input
                    ...
                    onChange={(event) => {
                      const next = Number(event.target.value);
                      onMaxFundingAmountChange(Number.isFinite(next) ? Math.max(0, Math.floor(next)) : 0);
                    }}
                    className="ml-1 w-28 rounded bg-stone-950 border border-stone-700 px-2 py-1 text-right text-xs font-black text-stone-100 outline-none"
                  />
                </label>
